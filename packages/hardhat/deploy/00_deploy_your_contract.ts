...
/**
 * Deploys a contract named "Nftizer" using the deployer account and
 * constructor arguments set to the deployer address
 *
 * @param hre HardhatRuntimeEnvironment object.
 */
const deployNftizer: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  /*
...
// e.g. yarn deploy --tags Nftizer
deployNftizer.tags = ["Nftizer"];
